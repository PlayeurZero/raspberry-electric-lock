...
Exécutable permettant d'ouvrir une gâche électrique à l'aide d'un bouton physique ou via une API web.
...
```sh
git clone https://github.com/PlayeurZero/raspberry-electric-lock /home/pi/raspberry-electric-lock \
